...
public class BasicGameApp implements Runnable, KeyListener {
    ...
    public BasicGameApp() {
        ...
        StartPic = Toolkit.getDefaultToolkit().getImage("Startscr.png");
...
// put your code to do things here.
    ...
    public void moveThings() {
        ...
        for (int y = 0; y < birdsArray.length; y++) {
            birdsArray[y].bounce();
        }
        for (int y = 0; y < birdsArray2.length; y++) {
            birdsArray2[y].wrap();
        }
    }
